...
if(isset($_POST['submit']))
{
    ...
    if (($amount)<0)//check input of negative value by user
   {
    ...
    else if($amount > $sql1['balance']) //check insufficient balance.
    {
...
<body style="background-color:#FEFEFA">
	<div class="container">
        <h2 class="text-center pt-4" style="background-color:#FEFEFA;border-radius:30px;box-shadow:2px 2px 10px black; padding:5px 5px 5px 5px;">Transaction</h2>
            <?php
                include 'config.php';
                $sid=$_GET['id'];
